...
#def monkeyDistance(pos1, pos2):
#  return int(util.manhattanDistance(pos1, pos2))
#capture.noisyDistance = monkeyDistance
...
def createTeam(firstIndex, secondIndex, isRed,
 #              first = 'OffensiveReflexAgent', second = 'DefensiveReflexAgent'):
               first = 'BothReflexAgent', second = 'BlockerReflexAgent'):
  ...
  def getWeights(self, state, action):
    ...
    if self.mode == 'offense':
        return {
            ...
            'distanceToPower':-100, # get that power pellet
