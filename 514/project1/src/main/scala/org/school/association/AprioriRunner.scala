...
import org.school.core.LoaderFactory
...
object AprioriRunner {
    ...
    private def printVersion() = {
        println("Apriori Version " + Application.Version)
        exit
    }
    ...
    private def printHelp(options: Options) = {
        ...
        format.printHelp("java -jar school.jar org.school.apriori.AprioriRunner", options)
        exit
    }
}
